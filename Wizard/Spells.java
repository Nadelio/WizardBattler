...
public class Spells
{
    ...
    public int useSpell(String spellName)
    {
        ...
        if(FightProcesses.attackRoll(FightProcesses.getTurnData(FightProcesses.getTurnCount() - 1).getMemberInPlay().getRoll()) > currentTarget.getArmor())
        {
            ...
            else if(currentSpell.getHasEffect() && (currentSpell.getIsHarmful() == false)){currentSpell.effectProcess(FightProcesses.getTurnData(FightProcesses.getTurnCount()).getMemberInPlay());}
